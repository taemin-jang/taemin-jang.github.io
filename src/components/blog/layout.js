      ...
      <main className="bg-white py-12 sm:py-20">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <div className="mx-auto">
            ...
            <StaticImage
              className="mt-8 rounded-3xl border-solid border-inherit border-2"
              src="../../images/preflight.png"
            ></StaticImage>
          </div>
          <div className="mx-auto mt-10 pb-10 max-w-2xl gap-x-8 gap-y-16 border-b border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none">
