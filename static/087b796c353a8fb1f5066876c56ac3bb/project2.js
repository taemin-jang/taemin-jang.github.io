...
const Project2 = () => {
  return (
    <div className="relative">
      <div className=" before:bg-primary-project2 py-24 sm:py-52 before:content-['']  before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:-z-10">
